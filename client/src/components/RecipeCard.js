      ...
      <div>
        ...
        <div className={styles.RecipeCardContainer}>
          ...
          <div className={styles.RecipeCardDescription}>
            If you really like eggs, then you will really like this recipe.
            <br />
            <br />
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi
            deleniti accusamus veniam nihil sapiente repudiandae ducimus cumque
            quisquam nam sed sint est voluptas ex, aspernatur quia adipisci
            eius. Ducimus, quaerat!
          </div>
        </div>
      </div>
    );
